		...
		<section class="panel">
			...
			<section class="user-data">
				...
				<p>
					...
					<a href={selectedUser.profile_image_url ?? '#'} target="_blank">View</a>
				</p>
				...
				<p>
					<strong>SE Points Name:</strong>
					{selectedUser.streamElementsData.pointsName ?? 'N/A'}
				</p>
			</section>
