...
<main>
	...
	<section class="block2">
		...
		<p>
			Global Economy, 7TV Integration, AFK, Fun, Moderation...
			<br />
		...
		<section class="modules">
			...
			<section class="module">
				...
				<p>
					Integration with 7TV allows you to manage your emotes, editors, cosmetics and sets without
					leaving platform of your choice.
				</p>
				<button on:click={() => checkItOut('7tv')}>Check it out!</button>
			</section>
			<section class="module">
				<section class="title">
					<h2>AFK/Reminders</h2>
			...
			<section class="module">
				...
				<p>Tools to help manage your Twitch chat and keep it safe and enjoyable for everyone.</p>
				<button on:click={() => checkItOut('moderation')}>Check it out!</button>
			</section>
	...
	<section class="block3">
		...
		<section class="projects">
			<a href="https://xslash.itch.io/emoteguesser">
				<section class="img-wrapper">
					<img src={egLogo} alt="EmoteGuesser Logo" />
				</section>
				<p>EmoteGuesser</p>
			</a>
			<a href="https://github.com/Xslash58">
				<section class="img-wrapper">
